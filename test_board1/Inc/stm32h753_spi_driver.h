/*
 * stm32h753_spi_driver.h
 *
 *  Created on: Jul 10, 2024
 *      Author: Bharath
 */

#ifndef STM32H753_SPI_DRIVER_H_
#define STM32H753_SPI_DRIVER_H_
...
#define SPI_BUS_CONFIG_SIMPLEX_TX_ONLY  1 /* SPI Simplex bux receive only configuration */
#define SPI_BUS_CONFIG_SIMPLEX_RX_ONLY  2 /* SPI Simplex bux receive only configuration */
#define SPI_BUS_CONFIG_HD               3 /* SPI Half-duplex bus configuration          */
 ...
 */
#define SPI_FLAG_TXE    ( 1 << SPI_SR_TXP)
#define SPI_FLAG_RXNE   ( 1 << SPI_SR_RXWNE)
