...
#include "stm32h753_I2C_driver.h"
...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
    ...
    /* ACK control bit */
    tempreg |= pI2CHandle->I2C_Config.I2C_ACKControl << I2C_CR1_NACKIE;
    ...
    pI2CHandle->pI2Cx->TIMINGR = (tempreg & 0x3F);
}
...
void I2C_IRQPriorityConfig(uint8_t IRQNumber, uint32_t IRQPriority)
{
    ...
    *(NVIC_PR1_BADDR + iprx) |= (IRQPriority << shift_amount);
}
...
void I2C_EV_IRQHandling(I2C_Handle_t *pI2CHandle)
{
    ...
    temp1 = pI2CHandle->pI2Cx->CR2 & (1 << I2C_CR1_ERRIE);
    temp2 = pI2CHandle->pI2Cx->CR2 & (1 << I2C_CR1_TCIE);
    temp3 = pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_RXNE);
    ...
    temp3 = pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_ADDR);
    ...
    temp3 = pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_TXIS);
    ...
    if(temp1 && temp3)
    {
        ...
        if(pI2CHandle->TxRxState == I2C_BUSY_IN_TX)
        {
            ...
            if(pI2CHandle->pI2Cx->ISR && (1 << I2C_ISR_STOPF))
            {
                if(pI2CHandle->TxLen == 0)
                {
                    /* Generate STOP condition */
                    if(pI2CHandle->Sr == I2C_DISABLE_ISR)
                    {
                        I2C_GenerateStopCondition(pI2CHandle->pI2Cx);
                    }
    ...
    temp3 = pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_STOPF);
    ...
    temp3 = pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_TXE);

    /* Handling for interrupt generated by TXE event */
    if(temp1 && temp2 && temp3)
    {
        /* Checking device mode */
        if(pI2CHandle->pI2Cx->ISR & (1 << I2C_ICR_PECCF))
        {
            if(pI2CHandle->TxRxState == I2C_BUSY_IN_TX)
            {
        ...
        else
        {
            ...
            if(pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_TCR))
            {
    ...
    {
        /* Checking device mode */
        if(pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_RXNE))
        {
            /* RXNE flag is set */
...
void I2C_ER_IRQHandling(I2C_Handle_t *pI2CHandle)
{
    ...
    temp2 = (pI2CHandle->pI2Cx->CR2) & (1 << I2C_CR1_ERRIE);

    /* Checking for bus error */
    temp1 = (pI2CHandle->pI2Cx->ISR) & (1 << I2C_ERROR_BERR);
    if(temp1 && temp2)
    {
        /* Clear the bus error flag */
        pI2CHandle->pI2Cx->ISR &= ~(1 << I2C_ERROR_BERR);
    ...
    temp1 = (pI2CHandle->pI2Cx->ISR) & (1 << I2C_ERROR_ARLO);
    if(temp1 && temp2)
    {
        /* Clear the arbitration lost error flag */
        pI2CHandle->pI2Cx->ISR &= ~(1 << I2C_ERROR_ARLO);
    ...
    temp1 = (pI2CHandle->pI2Cx->ISR) & (1 << I2C_ERROR_AF);
    if(temp1 && temp2)
    {
        /* Clear the ACK failure error flag */
        pI2CHandle->pI2Cx->ISR &= ~(1 << I2C_ERROR_AF);
    ...
    temp1 = (pI2CHandle->pI2Cx->ISR) & (1 << I2C_ERROR_OVR);
    if(temp1 && temp2)
    {
        /* Clear the Overrun/Underrun error flag */
        pI2CHandle->pI2Cx->ISR &= ~(1 << I2C_ERROR_OVR);
    ...
    temp1 = (pI2CHandle->pI2Cx->ISR) & (1 << I2C_ERROR_TIMEOUT);
    if(temp1 && temp2)
    {
        /* Clear the Time out error flag */
        pI2CHandle->pI2Cx->ISR &= ~(1 << I2C_ERROR_TIMEOUT);

        /* Notify application about error */
        I2C_ApplicationEventCallback(pI2CHandle, I2C_ISR_TIMEOUT);
    }
}
...
void I2C_SlaveEnableDisableCallbackEvents(I2C_RegDef_t *pI2Cx, uint8_t EnorDi)
{
    if(EnorDi == Enable)
    {
        pI2Cx->CR2 |= (1 << I2C_CR1_ERRIE);
        pI2Cx->CR2 |= (1 << I2C_CR1_TCIE);
        pI2Cx->CR2 |= (1 << I2C_CR1_STOPIE);
    }
    else
    {
        pI2Cx->CR2 &= ~(1 << I2C_CR1_TCIE);
...
static void I2C_ClearAddrFlag(I2C_Handle_t *pI2CHandle)
{
    ...
    if(pI2CHandle->pI2Cx->ISR & (1 << I2C_ISR_DIR))
    {
        ...
        {
            /* Clearing ADDR flag, reading ISR */
            dummy_read = pI2CHandle->pI2Cx->ISR;
            dummy_read = pI2CHandle->pI2Cx->ISR;
            (void)dummy_read;
        }
